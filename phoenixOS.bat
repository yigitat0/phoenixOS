...
echo KEY 1: 987-2002-4596RTX-4544TTX-1024 KEY 2: 987-2007-4568BGF-5423OOX-1024 > Key.txt
cd C:\windows\system32
cls
echo.
echo.
...
:8
cls
echo Butun Kodlar phoenixOS Sirketine Aittir
timeout 1 > nul
exit
exit
exit
